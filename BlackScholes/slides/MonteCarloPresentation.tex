...
\setbeamertemplate{footline}{
    \leavevmode
    \hbox{
        \begin{beamercolorbox}[wd=.329\paperwidth,ht=2.8ex,dp=1.2ex,center]{author in head/foot}
            \color{white}\scriptsize Monte Carlo Simulation
        \end{beamercolorbox}%
        \begin{beamercolorbox}[wd=.337\paperwidth,ht=2.8ex,dp=1.2ex,center]{title in head/foot}
            \color{white}\scriptsize Pricing de produits dérivés
        \end{beamercolorbox}%
        \begin{beamercolorbox}[wd=.329\paperwidth,ht=2.8ex,dp=1.2ex,center]{date in head/foot}
...
\begin{frame}
    ...
    Elles peuvent donc être réparties entre plusieurs c\oe{}urs du processeur.
