...
Result callBlackScholes(double S0, double K , double r , double T , double sigma , std::size_t Nsim)
{
    ...
    const double stdPrice = std::sqrt(varControlDiscountPayoff/static_cast<double>(Nsim));
